      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-1 border-l border-gray-200 dark:border-neutral-800 pl-3 ml-1">
          ...
          <button
            ...
            className={`p-2 rounded-md transition-colors ${
              isRightOpen ? 'text-white dark:text-white bg-gray-200 dark:bg-neutral-800' : 'text-gray-600 dark:text-neutral-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-neutral-800'
            }`}
