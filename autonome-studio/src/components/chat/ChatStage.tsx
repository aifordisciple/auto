...
export function ChatStage() {
  ...
  return (
    <div className="flex h-full w-full bg-[#121212] overflow-hidden">
      ...
      {/* 右侧：主聊天区域 */}
      <div className="flex-1 flex flex-col bg-[#1e1e1f] relative">
        ...
        {/* 底部输入区 */}
        <div className="shrink-0 px-4 pt-2 pb-3 bg-[#1e1e1f]">
          <div className="max-w-4xl mx-auto">
            <div className="bg-[#121212] border border-neutral-800/60 rounded-3xl p-2 focus-within:ring-1 focus-within:ring-blue-500/50 transition-all shadow-lg flex flex-col">
              <textarea
                value={inputValue}
