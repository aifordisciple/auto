...
export function ParameterItem({
  ...
  return (
    <div
      className={`border rounded-lg mb-2 overflow-hidden transition-all duration-200 ${
        isDragged
          ? 'border-blue-500/50 bg-blue-500/10 opacity-50 scale-[0.98]'
          : isDragOver
    ...
    >
      ...
      <div className="flex items-center gap-2 p-2">
        {/* 拖拽手柄 - 可拖拽状态 */}
        <div
          className="text-neutral-500 cursor-grab active:cursor-grabbing hover:text-neutral-300 transition-colors"
          title="拖拽排序"
        >
