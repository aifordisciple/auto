...
包含 RNA-Seq QC、Variant Calling、scRNA 分析等流水线任务
"""
...
from app.services.task_logger import create_task_logger


def register_pipeline_tasks(celery_app: Celery):
    """
    注册流水线任务到 Celery
...
out_path = f"/workspace/{out_filename}"
...
"""
        ...
        try:
            ...
            container = docker_client.containers.run(
                ...
                volumes={host_upload_dir: {'bind': '/workspace', 'mode': 'rw'}},
                detach=False,
                remove=True,
                stdout=True,
                stderr=True
    ...
    return {
        "run_rnaseq_qc_pipeline": run_rnaseq_qc_pipeline,
        "run_variant_calling_pipeline": run_variant_calling_pipeline,
        "run_scrna_analysis_pipeline": run_scrna_analysis_pipeline,
        "run_geo_single_cell_pipeline": run_geo_single_cell_pipeline,
    }