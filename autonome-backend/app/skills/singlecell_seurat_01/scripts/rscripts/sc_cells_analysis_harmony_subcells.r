...
# opt$dims <- 25
# opt$infile <- "/data1/project/NBioS-2024-03271-D_gastric_cancer/figures/fig_bycell_Pit/A_recluster/cell_cluster_L1.rds"
# # opt$infile <- "cells_analysis.rds"
...
# opt$samplelist <- "Pat01-B,Pat02-B,Pat03-B,Pat04-B,Pat05-B,Pat06-B,Pat07-B,Pat08-B,Pat09-B,Pat10-B,Pat11-B,Pat12-B,Pat13-B,Pat14-B,Pat15-B,Pat16-B,Pat17-B,Pat18-B,Pat19-B,Pat20-B,Pat22-B,Pat23-B,Pat24-B,Pat01-A,Pat02-A,Pat03-A,Pat04-A,Pat05-A,Pat06-A,Pat07-A,Pat08-A,Pat09-A,Pat10-A,Pat11-A,Pat12-A,Pat13-A,Pat14-A,Pat15-A,Pat16-A,Pat17-A,Pat18-A,Pat19-A,Pat20-A,Pat21-A,Pat22-A,Pat23-A,Pat24-A,Pat25-A,Pat26-A,Pat27-A,Pat28-A,Pat29-A"
# opt$listname <- "tumor,tumor,tumor,tumor,tumor,tumor,tumor,tumor,tumor,tumor,tumor,tumor,tumor,tumor,tumor,tumor,tumor,tumor,tumor,tumor,tumor,tumor,tumor,normal,normal,normal,normal,normal,normal,normal,normal,normal,normal,normal,normal,normal,normal,normal,normal,normal,normal,normal,normal,normal,normal,normal,normal,normal,normal,normal,normal,normal"
# opt$resolution = 0.3
...
# deg <- subset(combined_markers,avg_log2FC>=0.5|avg_log2FC<=-0.5)
# deg <- subset(deg,pct.1-pct.2>=0.25|pct.1-pct.2<=-0.25)
...
# system("py3 /Users/chengchao/biosource/besaltgraphic/honeycomb/apps/single-cell/scanpy_plot.py -s ../sc.h5ad -m ./top3_combined_markers_export.xls -O top3_scanpy")
