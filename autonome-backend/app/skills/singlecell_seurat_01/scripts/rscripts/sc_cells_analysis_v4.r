...
# opt$dims <- 50
# opt$infile <- "/data1/project/NBioS-2023-12025_DKD/basic/GSE204880_scRNAseq_mouse/result/singlecell/1_preprocessing/sc_preprocessing.rds"
...
# opt$samplelist <- "WTK_1,WTK_2,DBK_1,DBK_2"
# opt$listname <- "WT,WT,DP,DP"
# opt$resolution = 0.6
# # opt$keeps = "43,49,50,8,26,36,46,41,9,45,62,6,20,33,52,55"
# opt$sctypedb = "/public/database/singlecell/sctype_marker_db.xlsx"
# opt$tissue = "mouse_kidney_glomerulus"
